...
napalm-ansible
echo "Installing DedOps roles"
sudo ansible-galaxy install debops.secret
sudo ansible-galaxy install debops.nginx
sudo ansible-galaxy install debops.php
sudo ansible-galaxy install debops.mariadb_server
sudo ansible-galaxy install debops.phpipam
